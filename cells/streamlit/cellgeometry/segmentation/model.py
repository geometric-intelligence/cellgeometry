...
import torch
from gconv3d import groupConv3d
...
class Modified3DUNet_g(nn.Module):
    def __init__(self, in_channels, n_classes, base_n_filter=8):
        super(Modified3DUNet, self).__init__()
        self.in_channels = in_channels
        self.n_classes = n_classes
        ...
        self.ds2_1x1_conv3d = groupConv3d(
            self.base_n_filter * 8,
            self.n_classes,
            kernel_size=1,
            stride=1,
        ...
        self.ds3_1x1_conv3d = groupConv3d(
            self.base_n_filter * 4,
            self.n_classes,
            kernel_size=1,
            stride=1,
